...
class RoadNetwork (object):
	...
	def _extract_directions(self, item, following, side):
		...
		for branch in following:
			...
			last_angle = trajeometry.vector_angle(item_vectors[:, -1], branch_vectors[:, branch_vectors.shape[1]])
			if item_vectors[0, -1]*branch_vectors[1, branch_vectors.shape[1]] - item_vectors[1, -1]*branch_vectors[0, branch_vectors.shape[1]] < 0:
